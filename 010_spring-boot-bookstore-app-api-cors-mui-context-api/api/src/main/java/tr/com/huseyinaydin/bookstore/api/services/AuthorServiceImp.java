...
import tr.com.huseyinaydin.bookstore.api.exceptions.notFoundExceptions.AuthorNotFoundException;
import tr.com.huseyinaydin.bookstore.api.repositories.AuthorRepository;
...
public class AuthorServiceImp implements AuthorService {
	...
	public Set<Author> getAuthorsByIds(List<Integer> authorIds) {
		...
		authorIds.forEach(id -> authors.add(getOneAuthor(id).getData()));
		return authors;
