package tr.com.huseyinaydin.bookstore.api.exceptions;
...
import tr.com.huseyinaydin.bookstore.api.entities.models.ApiErrorResponse;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex, HttpHeaders headers,
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("MissingPathVariable");
	}
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		for (FieldError err : ex.getFieldErrors()) {
			errors.add(err.getField() + " : " + err.getDefaultMessage() + " Rejected Value: " + err.getRejectedValue());
		}
